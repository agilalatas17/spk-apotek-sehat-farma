<x-guest-layout>
    ...
    <div class="mt-40 justify-center flex flex-col md:flex-row">
        <div class="p-6 md:p-8 w-full max-w-xl">
            <h2 class="font-anuphan text-5xl font-bold text-sky-500 mb-auto">Login</h2>
            <p class="text-base sm:text-base text-gray-800 mt-2">Hi, Welcome back Admin <span
                    class="inline-block text-xl sm:text-base">👋</span>
            </p>
            ...
            <form method="POST" action="{{ route('login.admin.post') }}" class="space-y-2">
                @csrf
                ...
                <div class="flex items-center justify-between py-2 px-2">
                    <label for="remember_me" class="inline-flex items-center">
                        <input id="remember_me" type="checkbox"
                            class="rounded-none text-lg border-gray-300 text-gray-900 shadow-sm focus:ring-gray-100"
                            name="remember">
                ...
                <div class="flex items-center justify-end mt-4">
                    <x-primary-button
                        class="w-full flex justify-center py-4 px-4 border border-transparent rounded-lg text-xl uppercase font-medium text-zinc-50 bg-sky-500 hover:bg-sky-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition duration-200">
                        {{ __('Sign In') }}
                    </x-primary-button>
                </div>
