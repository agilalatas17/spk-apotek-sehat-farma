<x-guest-layout>
    ...
    <div class="mt-20 justify-center flex flex-col md:flex-row">
        <div class="p-6 md:p-8 w-full max-w-xl">
            ...
            <p class="text-base sm:text-base text-gray-900 mt-2">Hi, Please create your account as admin</p>
            ...
            <form method="POST" action="{{ route('register.admin.post') }}" class="space-y-2">
                @csrf
